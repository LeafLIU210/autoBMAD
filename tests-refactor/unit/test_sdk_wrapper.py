...
注意：这些测试针对的是旧版SDK包装器。新代码应使用 sdk_helper.execute_sdk_call。
"""
import asyncio
import pytest
...
# Mark tests as deprecated since the code is being migrated to sdk_helper
pytestmark = pytest.mark.skip(reason="Tests for deprecated SDK wrapper interface - use sdk_helper instead")
