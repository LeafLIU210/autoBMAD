...
class AsyncDebugger:
    ...
    def __init__(
        ...
        # 初始化远程调试器
        self.remote_debugger: Optional[RemoteDebugger] = None
        if self.enable_remote_debug:
            try:
                self.remote_debugger = get_remote_debugger(self.debug_config)
    ...
    async def debug_async_operation(
        ...
        breakpoints: Optional[List[tuple]] = None,
