...
class TestQualityGateOrchestrator:
    ...
    async def test_execute_quality_gates_skip_tests(self, temp_dirs):
        ...
        with patch('autoBMAD.epic_automation.agents.quality_agents.RuffAgent') as mock_ruff, \
             patch('autoBMAD.epic_automation.agents.quality_agents.BasedPyrightAgent') as mock_basedpyright:
