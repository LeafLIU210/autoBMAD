...
echo ""
echo "使用方法:"
echo "  PYTHONPATH=. python autoBMAD/epic_automation/epic_driver.py docs/epics/your-epic.md --verbose"
echo ""
echo "快速开发（跳过质量门控）:"
echo "  PYTHONPATH=. python autoBMAD/epic_automation/epic_driver.py docs/epics/your-epic.md --skip-quality --verbose"
