...
if HAS_BMAD_WORKFLOW:
    ...
    try:
        ...
        pytestmark = pytest.mark.skipif(
            True,
            reason="qa.qa_tools_integration module not found in bmad-workflow"
        )
else:
    IMPORTS_SUCCESSFUL = False

# Only define test classes if imports were successful
if HAS_BMAD_WORKFLOW and IMPORTS_SUCCESSFUL:
