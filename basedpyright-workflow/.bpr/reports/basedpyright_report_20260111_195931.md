# BasedPyright 检查报告
**生成时间**: 2026-01-11 19:59:31
**检查时间**: 2026-01-11T19:59:31.732536
...
#### 1. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\epic_driver.py:1875

- **规则**: `reportAttributeAccessIssue`
- **位置**: 第 1875 行, 第 62 列
- **错误信息**: "get_cancellation_manager" 不是 "autoBMAD.epic_automation.monitoring" 模块的已知属性

#### 2. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\epic_driver.py:1884
...
#### 3. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\epic_driver.py:1886
...
#### 4. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\epic_driver.py:1888
...
d:\GITHUB\pytQt_template\autoBMAD\epic_automation\epic_driver.py
  d:\GITHUB\pytQt_template\autoBMAD\epic_automation\epic_driver.py:1875:63 - error: "get_cancellation_manager" 不是 "autoBMAD.epic_automation.monitoring" 模块的已知属性 (reportAttributeAccessIssue)
  d:\GITHUB\pytQt_template\autoBMAD\epic_automation\epic_driver.py:1884:33 - error: 部分参数的类型未知
    实参对应于 "hasattr" 函数中的 "obj" 形参
    参数类型为 "Unknown | Any" (reportUnknownArgumentType)
  d:\GITHUB\pytQt_template\autoBMAD\epic_automation\epic_driver.py:1886:30 - error: 部分参数的类型未知
    实参对应于 "__new__" 函数中的 "o" 形参
    参数类型为 "Unknown | Any" (reportUnknownArgumentType)
  d:\GITHUB\pytQt_template\autoBMAD\epic_automation\epic_driver.py:1888:55 - error: 部分参数的类型未知
    实参对应于 "__init__" 函数中的 "iterable" 形参
    参数类型为 "Unknown | Any" (reportUnknownArgumentType)
