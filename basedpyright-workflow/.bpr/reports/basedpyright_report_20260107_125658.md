# BasedPyright 检查报告
**生成时间**: 2026-01-07 12:56:58
**检查时间**: 2026-01-07T12:56:58.034496
...
- `d:\GITHUB\pytQt_template\autoBMAD\epic_automation\state_manager.py`: 13 个错误
- `d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_wrapper.py`: 12 个错误
- `d:\GITHUB\pytQt_template\autoBMAD\epic_automation\qa_agent.py`: 8 个错误
- `d:\GITHUB\pytQt_template\autoBMAD\epic_automation\code_quality_agent.py`: 2 个错误
...
#### 1. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\code_quality_agent.py:191
...
#### 2. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\code_quality_agent.py:234
...
#### 3. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\qa_agent.py:5

- **规则**: `reportInvalidStringEscapeSequence`
- **位置**: 第 5 行, 第 8 列
- **错误信息**: 字符串字面量中有不受支持的转义序列

#### 4. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\qa_agent.py:5
...
#### 7. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\qa_agent.py:23

- **规则**: `reportUnusedImport`
- **位置**: 第 23 行, 第 7 列
- **错误信息**: "time" 导入项未使用

#### 8. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\qa_agent.py:24

- **规则**: `reportUnusedImport`
- **位置**: 第 24 行, 第 21 列
- **错误信息**: "datetime" 导入项未使用

#### 9. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\qa_agent.py:30

- **规则**: `reportUnusedImport`
- **位置**: 第 30 行, 第 52 列
- **错误信息**: "SDKErrorType" 导入项未使用

#### 10. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\qa_agent.py:215
...
#### 11. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_session_manager.py:5

- **规则**: `reportInvalidStringEscapeSequence`
- **位置**: 第 5 行, 第 8 列
- **错误信息**: 字符串字面量中有不受支持的转义序列

#### 12. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_session_manager.py:5
...
#### 15. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_session_manager.py:230
...
#### 16. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_session_manager.py:255
...
#### 17. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_session_manager.py:259
...
#### 18. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_session_manager.py:312
...
#### 19. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_session_manager.py:340
...
#### 20. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_session_manager.py:383
...
#### 21. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_session_manager.py:412
...
#### 22. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_session_manager.py:431

- **规则**: `reportPossiblyUnboundVariable`
- **位置**: 第 431 行, 第 43 列
- **错误信息**: "start_time" 可能未绑定

#### 23. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_session_manager.py:432

- **规则**: `reportPossiblyUnboundVariable`
- **位置**: 第 432 行, 第 23 列
- **错误信息**: "session_id" 可能未绑定

#### 24. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_wrapper.py:5

- **规则**: `reportInvalidStringEscapeSequence`
- **位置**: 第 5 行, 第 8 列
- **错误信息**: 字符串字面量中有不受支持的转义序列

#### 25. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_wrapper.py:5
...
#### 28. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_wrapper.py:16

- **规则**: `reportUnusedImport`
- **位置**: 第 16 行, 第 7 列
- **错误信息**: "sys" 导入项未使用

#### 29. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_wrapper.py:20

- **规则**: `reportUnusedImport`
- **位置**: 第 20 行, 第 23 列
- **错误信息**: "asynccontextmanager" 导入项未使用

#### 30. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_wrapper.py:85

- **规则**: `reportUnknownParameterType`
- **位置**: 第 85 行, 第 23 列
- **错误信息**: "generator" 参数的类型未知

#### 31. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_wrapper.py:85

- **规则**: `reportMissingParameterType`
- **位置**: 第 85 行, 第 23 列
- **错误信息**: "generator" 参数缺少类型注解

#### 32. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_wrapper.py:94

- **规则**: `reportUnknownParameterType`
- **位置**: 第 94 行, 第 14 列
- **错误信息**: 返回类型未知

#### 33. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_wrapper.py:118
...
#### 34. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_wrapper.py:123
...
#### 35. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\sdk_wrapper.py:485
...
#### 36. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\state_manager.py:5

- **规则**: `reportInvalidStringEscapeSequence`
- **位置**: 第 5 行, 第 8 列
- **错误信息**: 字符串字面量中有不受支持的转义序列

#### 37. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\state_manager.py:5

- **规则**: `reportInvalidStringEscapeSequence`
- **位置**: 第 5 行, 第 15 列
- **错误信息**: 字符串字面量中有不受支持的转义序列

#### 38. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\state_manager.py:5

- **规则**: `reportInvalidStringEscapeSequence`
- **位置**: 第 5 行, 第 39 列
- **错误信息**: 字符串字面量中有不受支持的转义序列

#### 39. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\state_manager.py:5

- **规则**: `reportInvalidStringEscapeSequence`
- **位置**: 第 5 行, 第 55 列
- **错误信息**: 字符串字面量中有不受支持的转义序列

#### 40. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\state_manager.py:20

- **规则**: `reportUnusedImport`
- **位置**: 第 20 行, 第 7 列
- **错误信息**: "uuid" 导入项未使用

#### 41. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\state_manager.py:21

- **规则**: `reportUnusedImport`
- **位置**: 第 21 行, 第 7 列
- **错误信息**: "weakref" 导入项未使用

#### 42. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\state_manager.py:52

- **规则**: `reportUndefinedVariable`
- **位置**: 第 52 行, 第 27 列
- **错误信息**: "Dict" 未定义

#### 43. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\state_manager.py:52

- **规则**: `reportMissingTypeArgument`
- **位置**: 第 52 行, 第 37 列
- **错误信息**: "Task" 泛型类应有类型参数

#### 44. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\state_manager.py:62

- **规则**: `reportUnusedVariable`
- **位置**: 第 62 行, 第 8 列
- **错误信息**: 变量 "task_id" 未使用

#### 45. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\state_manager.py:82

- **规则**: `reportMissingTypeArgument`
- **位置**: 第 82 行, 第 26 列
- **错误信息**: "Queue" 泛型类应有类型参数

#### 46. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\state_manager.py:98
...
#### 47. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\state_manager.py:313

- **规则**: `reportUnusedVariable`
- **位置**: 第 313 行, 第 16 列
- **错误信息**: 变量 "story_id" 未使用

#### 48. d:\GITHUB\pytQt_template\autoBMAD\epic_automation\state_manager.py:627
...
d:\GITHUB\pytQt_template\autoBMAD\epic_automation\code_quality_agent.py
  d:\GITHUB\pytQt_template\autoBMAD\epic_automation\code_quality_agent.py:191:46 - error: 无法访问 "StateManager" 类的 "add_quality_phase_record" 属性
    属性 "add_quality_phase_record" 未知 (reportAttributeAccessIssue)
  d:\GITHUB\pytQt_template\autoBMAD\epic_automation\code_quality_agent.py:234:46 - error: 无法访问 "StateManager" 类的 "add_quality_phase_record" 属性
    属性 "add_quality_phase_record" 未知 (reportAttributeAccessIssue)
