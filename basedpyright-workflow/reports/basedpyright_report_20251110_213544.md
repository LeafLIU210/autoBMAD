...
**生成时间**: 2025-11-10 21:35:44

**检查时间**: 2025-11-10T21:35:44.492938
**检查目录**: `src`
...
- `d:\Python\fcmrawler\src\main_optimized.py`: 2 个错误
- `d:\Python\fcmrawler\src\models\database.py`: 2 个错误
- `d:\Python\fcmrawler\src\models\entities.py`: 1 个错误
- `d:\Python\fcmrawler\src\services\__init__.py`: 1 个错误
- `d:\Python\fcmrawler\src\services\secondary_url_service.py`: 1 个错误

### 按规则分组

- `reportImportCycles`: 4 次
- `reportOptionalMemberAccess`: 2 次
- `reportArgumentType`: 1 次

### 详细错误列表

#### 1. d:\Python\fcmrawler\src\main_optimized.py:331

- **规则**: `reportOptionalMemberAccess`
- **位置**: 第 331 行, 第 33 列
- **错误信息**: `None` 没有 "window_closing" 属性

#### 2. d:\Python\fcmrawler\src\main_optimized.py:334

- **规则**: `reportOptionalMemberAccess`
- **位置**: 第 334 行, 第 29 列
- **错误信息**: `None` 没有 "show" 属性
...
#### 4. d:\Python\fcmrawler\src\models\database.py:1
...
#### 5. d:\Python\fcmrawler\src\models\entities.py:1
...
#### 6. d:\Python\fcmrawler\src\services\__init__.py:1
...
#### 7. d:\Python\fcmrawler\src\services\secondary_url_service.py:1525

- **规则**: `reportArgumentType`
- **位置**: 第 1525 行, 第 26 列
- **错误信息**: "int" 类型的实参无法赋值给函数 "append" 中 "str" 类型的形参 "object"
  "int" 与 "str" 不兼容
...
45. `src\hooks\__init__.py`
46. `src\hooks\playwright_hook.py`
47. `src\legacy\__init__.py`
48. `src\legacy\element_extractor.py`
49. `src\legacy\website_analyzer.py`
50. `src\main.py`
51. `src\main_optimized.py`
52. `src\models\__init__.py`
53. `src\models\config.py`
54. `src\models\database.py`
55. `src\models\database_exceptions.py`
56. `src\models\entities.py`
57. `src\models\exceptions.py`
58. `src\models\field_change_detection_migration.py`
59. `src\models\field_schema_migration.py`
60. `src\models\url.py`
61. `src\models\url_config_migration.py`
62. `src\services\__init__.py`
63. `src\services\ai_analysis_service.py`
64. `src\services\ai_config_generator_service.py`
65. `src\services\api_test_service.py`
66. `src\services\async_config_bridge.py`
67. `src\services\audit_service.py`
68. `src\services\backup_service.py`
69. `src\services\batch_analysis_service.py`
70. `src\services\batch_crawl_service.py`
71. `src\services\batch_crawl_service_enhanced.py`
72. `src\services\cache_manager.py`
73. `src\services\change_detector.py`
74. `src\services\cms_detector.py`
75. `src\services\config_quality_assessor.py`
76. `src\services\config_service.py`
77. `src\services\config_test_service.py`
78. `src\services\config_validator.py`
79. `src\services\content_deduplication_service.py`
80. `src\services\content_search_service.py`
81. `src\services\crawl_execution_service.py`
82. `src\services\crawl_service.py`
83. `src\services\custom_report_generator.py`
84. `src\services\data_export_service.py`
85. `src\services\data_query_service.py`
86. `src\services\data_statistics_service.py`
87. `src\services\domain_analyzer.py`
88. `src\services\excel_import_service.py`
89. `src\services\field_management_service.py`
90. `src\services\field_template_manager.py`
91. `src\services\field_validator.py`
92. `src\services\kimi_client.py`
93. `src\services\page_structure_analyzer.py`
94. `src\services\persistence_service.py`
95. `src\services\pii_detector.py`
96. `src\services\rate_limiter.py`
97. `src\services\result_formatter.py`
98. `src\services\secondary_url_service.py`
99. `src\services\selector_generator.py`
100. `src\services\selector_optimizer.py`
101. `src\services\selector_tester.py`
102. `src\services\storage_manager.py`
103. `src\services\time_series_analyzer.py`
104. `src\services\url_service.py`
105. `src\services\url_validator.py`
106. `src\services\version_manager.py`
107. `src\utils\__init__.py`
108. `src\utils\async_bridge.py`
109. `src\utils\crypto.py`
110. `src\utils\data_validator.py`
111. `src\utils\key_manager.py`
112. `src\utils\performance_profiler.py`
113. `src\utils\playwright_detector.py`
114. `src\utils\request_rate_limiter.py`
115. `src\utils\retry_strategy.py`
...
d:\Python\fcmrawler\src\main_optimized.py
  ...
  d:\Python\fcmrawler\src\main_optimized.py:57:5 - warning: 由于这个类未使用 `@final` 装饰，其 `progress_updated` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\main_optimized.py:104:14 - warning: 由于这个类未使用 `@final` 装饰，其 `progress_widget` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\main_optimized.py:111:14 - warning: 由于这个类未使用 `@final` 装饰，其 `status_label` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\main_optimized.py:115:14 - warning: 由于这个类未使用 `@final` 装饰，其 `progress_bar` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\main_optimized.py:152:9 - warning: "showEvent" 方法没有用 `@override` 装饰，但覆写了 "QWidget" 类中的方法 (reportImplicitOverride)
  d:\Python\fcmrawler\src\main_optimized.py:152:25 - warning: "a0" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\main_optimized.py:168:5 - warning: 由于这个类未使用 `@final` 装饰，其 `loading_progress` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\main_optimized.py:169:5 - warning: 由于这个类未使用 `@final` 装饰，其 `loading_complete` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\main_optimized.py:170:5 - warning: 由于这个类未使用 `@final` 装饰，其 `loading_error` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\main_optimized.py:174:14 - warning: 由于这个类未使用 `@final` 装饰，其 `logger` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\main_optimized.py:175:33 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\main_optimized.py:177:9 - warning: "run" 方法没有用 `@override` 装饰，但覆写了 "QThread" 类中的方法 (reportImplicitOverride)
  d:\Python\fcmrawler\src\main_optimized.py:186:20 - warning: "os" 导入项未使用 (reportUnusedImport)
  d:\Python\fcmrawler\src\main_optimized.py:188:20 - warning: "threading" 导入项未使用 (reportUnusedImport)
  d:\Python\fcmrawler\src\main_optimized.py:199:17 - warning: 变量 "config_service" 未使用 (reportUnusedVariable)
  d:\Python\fcmrawler\src\main_optimized.py:212:24 - warning: "requests" 导入项未使用 (reportUnusedImport)
  d:\Python\fcmrawler\src\main_optimized.py:213:24 - warning: "aiohttp" 导入项未使用 (reportUnusedImport)
  d:\Python\fcmrawler\src\main_optimized.py:222:47 - warning: "WebsiteAnalyzerWrapper" 导入项未使用 (reportUnusedImport)
  d:\Python\fcmrawler\src\main_optimized.py:223:48 - warning: "ElementExtractorWrapper" 导入项未使用 (reportUnusedImport)
  d:\Python\fcmrawler\src\main_optimized.py:232:47 - warning: "ReportGenerator" 导入项未使用 (reportUnusedImport)
  d:\Python\fcmrawler\src\main_optimized.py:242:48 - warning: "QIcon" 导入项未使用 (reportUnusedImport)
  d:\Python\fcmrawler\src\main_optimized.py:243:42 - warning: "QSize" 导入项未使用 (reportUnusedImport)
  d:\Python\fcmrawler\src\main_optimized.py:288:24 - warning: "args" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\main_optimized.py:297:14 - warning: 由于这个类未使用 `@final` 装饰，其 `logger` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\main_optimized.py:298:14 - warning: 由于这个类未使用 `@final` 装饰，其 `start_time` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\main_optimized.py:307:14 - warning: 由于这个类未使用 `@final` 装饰，其 `splash` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\main_optimized.py:311:14 - warning: 由于这个类未使用 `@final` 装饰，其 `loader` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\main_optimized.py:312:27 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\main_optimized.py:312:36 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\main_optimized.py:331:34 - error: `None` 没有 "window_closing" 属性 (reportOptionalMemberAccess)
  d:\Python\fcmrawler\src\main_optimized.py:334:30 - error: `None` 没有 "show" 属性 (reportOptionalMemberAccess)
d:\Python\fcmrawler\src\models\config.py
  ...
  d:\Python\fcmrawler\src\models\config.py:382:9 - warning: "__str__" 方法没有用 `@override` 装饰，但覆写了 "object" 类中的方法 (reportImplicitOverride)
  d:\Python\fcmrawler\src\models\config.py:386:9 - warning: "__repr__" 方法没有用 `@override` 装饰，但覆写了 "object" 类中的方法 (reportImplicitOverride)
  d:\Python\fcmrawler\src\models\config.py:398:24 - warning: "db_manager" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\models\config.py:405:14 - warning: 由于这个类未使用 `@final` 装饰，其 `db_manager` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\models\config.py:457:45 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\config.py:481:50 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\config.py:508:50 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
d:\Python\fcmrawler\src\models\database.py
  ...
  d:\Python\fcmrawler\src\models\database.py:57:5 - warning: 由于这个类未使用 `@final` 装饰，其 `CURRENT_VERSION` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\models\database.py:60:5 - warning: 由于这个类未使用 `@final` 装饰，其 `VERSIONS` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\models\database.py:87:33 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:87:42 - warning: 此类型自 Python 3.10 起已弃用；请改用 "|" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:100:14 - warning: 由于这个类未使用 `@final` 装饰，其 `db_path` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\models\database.py:101:14 - warning: 由于这个类未使用 `@final` 装饰，其 `_local` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\models\database.py:102:14 - warning: 由于这个类未使用 `@final` 装饰，其 `_lock` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\models\database.py:705:37 - warning: "conn" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\models\database.py:966:46 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1013:39 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1042:51 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1071:21 - warning: "entity_class" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\models\database.py:1083:19 - warning: "entity" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\models\database.py:1121:35 - warning: "change" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\models\database.py:1159:34 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1213:37 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1262:39 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1304:55 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1337:58 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1410:9 - warning: "save_url_config" 方法的声明被同名声明遮蔽 (reportRedeclaration)
  d:\Python\fcmrawler\src\models\database.py:1410:31 - warning: "config" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\models\database.py:1410:42 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1463:9 - warning: "get_url_config" 方法的声明被同名声明遮蔽 (reportRedeclaration)
  d:\Python\fcmrawler\src\models\database.py:1463:49 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1463:58 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1463:68 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:1497:9 - warning: "get_url_configs_by_url" 方法的声明被同名声明遮蔽 (reportRedeclaration)
  d:\Python\fcmrawler\src\models\database.py:1497:54 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1497:59 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1497:69 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:1533:9 - warning: "get_default_url_config" 方法的声明被同名声明遮蔽 (reportRedeclaration)
  d:\Python\fcmrawler\src\models\database.py:1533:54 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1533:63 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1533:73 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:1569:9 - warning: "update_url_config" 方法的声明被同名声明遮蔽 (reportRedeclaration)
  d:\Python\fcmrawler\src\models\database.py:1569:33 - warning: "config" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\models\database.py:1609:9 - warning: "delete_url_config" 方法的声明被同名声明遮蔽 (reportRedeclaration)
  d:\Python\fcmrawler\src\models\database.py:1633:9 - warning: "set_default_url_config" 方法的声明被同名声明遮蔽 (reportRedeclaration)
  d:\Python\fcmrawler\src\models\database.py:1684:57 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1776:51 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1816:60 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1816:85 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1867:55 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1880:83 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1941:69 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1941:74 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1941:84 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:1968:50 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:1968:60 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:2011:46 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2012:50 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2100:70 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2129:86 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2129:95 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2129:105 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:2156:51 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2156:61 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:2156:70 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2236:72 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2236:98 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2236:103 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2236:113 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:2275:69 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2275:78 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2275:88 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:2338:78 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2338:83 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2338:93 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:2400:73 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2490:64 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2583:59 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2636:36 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2636:46 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:2672:44 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2672:53 - warning: 此类型自 Python 3.10 起已弃用；请改用 "|" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2705:45 - warning: 此类型自 Python 3.10 起已弃用；请改用 "|" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2740:43 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2828:43 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2872:55 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:2946:57 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3001:53 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3031:70 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3073:63 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3132:55 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3163:42 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3266:51 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3303:64 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3303:89 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3351:54 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3351:79 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3401:67 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3402:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3417:25 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3417:30 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:3453:55 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3550:53 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3584:56 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3584:81 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3629:58 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3642:82 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3684:78 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3726:61 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3726:86 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3726:91 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3726:101 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:3770:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3887:73 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3949:54 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:3983:72 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4053:58 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4053:67 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4053:72 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:4053:89 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4053:94 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4053:104 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:4086:35 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4086:44 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4086:49 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  ...
  d:\Python\fcmrawler\src\models\database.py:4129:42 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4129:51 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4129:61 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:4130:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4130:20 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:4210:27 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4210:64 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4211:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4211:15 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4211:25 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:4276:27 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4276:64 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4277:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4277:15 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4277:25 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:4327:27 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4327:64 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4328:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4328:15 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4328:25 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:4384:27 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4384:64 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4385:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4385:15 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4385:25 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:4567:49 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4567:58 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4567:68 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:4592:54 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4592:59 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4592:69 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:4619:54 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4619:63 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4619:73 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:4769:60 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4769:70 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\models\database.py:4792:35 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4792:44 - warning: 此类型自 Python 3.10 起已弃用；请改用 "|" (reportDeprecated)
  d:\Python\fcmrawler\src\models\database.py:4821:53 - warning: "entity_class" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\models\database.py:4829:14 - warning: 由于这个类未使用 `@final` 装饰，其 `db_manager` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\models\database.py:4830:14 - warning: 由于这个类未使用 `@final` 装饰，其 `entity_class` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\models\database.py:4831:14 - warning: 由于这个类未使用 `@final` 装饰，其 `table_name` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\models\database.py:4832:14 - warning: 由于这个类未使用 `@final` 装饰，其 `filters` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\models\database.py:4834:31 - warning: "entity_class" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\models\database.py:4851:23 - warning: "args" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\models\database.py:4859:34 - warning: "_get_connection" 在声明它受到保护的类之外被使用 (reportPrivateUsage)
  d:\Python\fcmrawler\src\models\database.py:4886:19 - warning: "entity_id" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\models\database.py:4889:34 - warning: "_get_connection" 在声明它受到保护的类之外被使用 (reportPrivateUsage)
  d:\Python\fcmrawler\src\models\database.py:4898:36 - warning: "expr" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\models\database.py:4908:34 - warning: "row" 参数缺少类型注解 (reportMissingParameterType)
d:\Python\fcmrawler\src\models\entities.py
...
d:\Python\fcmrawler\src\services\ai_analysis_service.py
  ...
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:375:59 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:375:69 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:424:64 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:424:74 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:424:83 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:424:93 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:461:46 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:461:56 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:461:84 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:461:94 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:490:46 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:490:56 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:490:84 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:490:94 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:514:36 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:514:46 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:514:63 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:514:73 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:515:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:515:20 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:540:54 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:540:64 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:540:81 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:540:91 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:572:57 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:572:67 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:572:76 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:572:86 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:615:48 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:615:57 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:615:67 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:633:32 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:650:34 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_analysis_service.py:650:44 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
d:\Python\fcmrawler\src\services\ai_config_generator_service.py
  ...
  d:\Python\fcmrawler\src\services\ai_config_generator_service.py:775:52 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_config_generator_service.py:775:62 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\ai_config_generator_service.py:810:46 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\ai_config_generator_service.py:810:56 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
...
d:\Python\fcmrawler\src\services\crawl_execution_service.py
  ...
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:141:75 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:141:85 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:174:45 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:174:55 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:189:16 - warning: "Dict[str, Any]" 一定是 "dict[Unknown, Unknown]" 的实例，无需再调用 `isinstance` (reportUnnecessaryIsInstance)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:190:13 - warning: 代码不会被执行 (reportUnreachable)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:245:63 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:320:49 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:320:58 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:320:68 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:320:85 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:320:95 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:453:65 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:453:70 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:453:80 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:453:90 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:453:100 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:518:58 - warning: "config_id" 未使用 (reportUnusedParameter)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:518:74 - warning: "extracted_data" 未使用 (reportUnusedParameter)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:518:90 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:518:100 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:541:79 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:541:89 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:632:52 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:632:101 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:712:52 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\crawl_execution_service.py:712:62 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
...
d:\Python\fcmrawler\src\services\secondary_url_service.py
  d:\Python\fcmrawler\src\services\secondary_url_service.py:29:35 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:29:41 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:29:47 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:29:57 - warning: 此类型自 Python 3.9 起已弃用；请改用 "set" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:29:57 - warning: "Set" 导入项未使用 (reportUnusedImport)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:29:62 - warning: 此类型自 Python 3.9 起已弃用；请改用 "tuple" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:29:62 - warning: "Tuple" 导入项未使用 (reportUnusedImport)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:29:69 - warning: 此类型自 Python 3.10 起已弃用；请改用 "|" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:64:14 - warning: 由于这个类未使用 `@final` 装饰，其 `db_manager` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:65:14 - warning: 由于这个类未使用 `@final` 装饰，其 `storage_manager` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:66:14 - warning: 由于这个类未使用 `@final` 装饰，其 `max_concurrent` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:67:14 - warning: 由于这个类未使用 `@final` 装饰，其 `logger` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:71:14 - warning: 由于这个类未使用 `@final` 装饰，其 `semaphore` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:74:14 - warning: 由于这个类未使用 `@final` 装饰，其 `ai_service` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:75:14 - warning: 由于这个类未使用 `@final` 装饰，其 `crawl_service` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:78:14 - warning: 由于这个类未使用 `@final` 装饰，其 `_exclude_patterns` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:99:14 - warning: 由于这个类未使用 `@final` 装饰，其 `_exclude_extensions` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:108:14 - warning: 由于这个类未使用 `@final` 装饰，其 `_compiled_patterns` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:132:18 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:132:27 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:132:37 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:133:28 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:133:47 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:134:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:161:74 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:161:83 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:161:93 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:233:72 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:268:55 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:300:39 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:310:27 - warning: "str" 一定是 "str" 的实例，无需再调用 `isinstance` (reportUnnecessaryIsInstance)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:336:43 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:404:15 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:406:18 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:406:28 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:407:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:471:25 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:472:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:619:69 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:619:74 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:619:84 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:746:61 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:746:70 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:754:59 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:773:74 - warning: 条件的计算结果始终为 `False`，因为类型 "Literal['pending', 'failed', 'timeout', 'retrying']" 和 "Literal['success']" 之间不存在交集 (reportUnnecessaryComparison)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:797:69 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:797:88 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:835:79 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:835:98 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:888:100 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:888:119 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:977:58 - warning: "base_url" 未使用 (reportUnusedParameter)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:977:76 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1008:15 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1010:18 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1010:28 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1011:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1092:44 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1092:73 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1098:13 - warning: 变量 "base_scheme" 未使用 (reportUnusedVariable)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1099:13 - warning: 变量 "base_netloc" 未使用 (reportUnusedVariable)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1129:40 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1129:54 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1149:15 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1150:28 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1150:47 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1151:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1151:20 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1195:30 - warning: "ai_service" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1199:33 - warning: "crawl_service" 参数缺少类型注解 (reportMissingParameterType)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1207:16 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1207:21 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1207:31 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1208:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1208:20 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1234:60 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1234:70 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1257:26 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1288:51 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1288:61 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1310:15 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1311:28 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1311:47 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1312:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1312:20 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1383:15 - warning: "execute_batch_secondary_crawl" 方法的声明被同名声明遮蔽 (reportRedeclaration)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1387:28 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1387:47 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1388:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1388:20 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1453:95 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1453:100 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1483:20 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1484:21 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1485:23 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1486:24 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1512:20 - warning: "datetime" 一定是 "datetime" 的实例，无需再调用 `isinstance` (reportUnnecessaryIsInstance)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1515:21 - warning: 代码不会被执行 (reportUnreachable)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1525:27 - error: "int" 类型的实参无法赋值给函数 "append" 中 "str" 类型的形参 "object"
    "int" 与 "str" 不兼容 (reportArgumentType)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1538:49 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1538:54 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1538:71 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1538:76 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1538:86 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1538:96 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1538:106 - warning: 此类型自 Python 3.10 起已弃用；请改用 "|" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1540:18 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1540:28 - warning: 此类型自 Python 3.10 起已弃用；请改用 "|" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1564:19 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1564:29 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1567:20 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1568:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1568:20 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1571:12 - warning: "Dict[str, Any]" 一定是 "dict[Unknown, Unknown]" 的实例，无需再调用 `isinstance` (reportUnnecessaryIsInstance)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1574:13 - warning: 代码不会被执行 (reportUnreachable)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1601:12 - warning: "Dict[str, Any]" 一定是 "dict[Unknown, Unknown]" 的实例，无需再调用 `isinstance` (reportUnnecessaryIsInstance)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1604:13 - warning: 代码不会被执行 (reportUnreachable)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1621:18 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1621:27 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1621:37 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1622:28 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1622:47 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1623:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1623:20 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1647:74 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1647:83 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1647:93 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1785:28 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1785:47 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1785:57 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1786:25 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1787:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1787:20 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1904:19 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1904:29 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1905:28 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1905:47 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1905:57 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1907:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:1907:20 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:2040:10 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:2040:15 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:2040:25 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:2100:10 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:2144:69 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:2144:78 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\secondary_url_service.py:2144:88 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
...
d:\Python\fcmrawler\src\services\storage_manager.py
  ...
  d:\Python\fcmrawler\src\services\storage_manager.py:1074:28 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\storage_manager.py:1074:38 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  ...
  d:\Python\fcmrawler\src\services\storage_manager.py:1175:21 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\storage_manager.py:1175:31 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\storage_manager.py:1206:28 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\storage_manager.py:1206:37 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\storage_manager.py:1277:25 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  ...
  d:\Python\fcmrawler\src\services\storage_manager.py:1289:20 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\storage_manager.py:1289:30 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\storage_manager.py:1312:31 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\storage_manager.py:1312:41 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
...
d:\Python\fcmrawler\src\services\url_service.py
  ...
  d:\Python\fcmrawler\src\services\url_service.py:1478:28 - warning: "str" 一定是 "str" 的实例，无需再调用 `isinstance` (reportUnnecessaryIsInstance)
  d:\Python\fcmrawler\src\services\url_service.py:1530:48 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\url_service.py:1530:62 - warning: 此类型自 Python 3.9 起已弃用；请改用 "set" (reportDeprecated)
  d:\Python\fcmrawler\src\services\url_service.py:1560:57 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\url_service.py:1576:27 - warning: "str" 一定是 "str" 的实例，无需再调用 `isinstance` (reportUnnecessaryIsInstance)
  d:\Python\fcmrawler\src\services\url_service.py:1628:42 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\services\url_service.py:1645:27 - warning: "str" 一定是 "str" 的实例，无需再调用 `isinstance` (reportUnnecessaryIsInstance)
  d:\Python\fcmrawler\src\services\url_service.py:1689:38 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\url_service.py:1689:82 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\services\url_service.py:1741:88 - warning: 此类型自 Python 3.9 起已弃用；请改用 "dict" (reportDeprecated)
  d:\Python\fcmrawler\src\services\url_service.py:1741:98 - warning: 不允许使用 `Any` 类型 (reportExplicitAny)
  d:\Python\fcmrawler\src\services\url_service.py:1779:15 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
...
d:\Python\fcmrawler\src\utils\playwright_detector.py
  d:\Python\fcmrawler\src\utils\playwright_detector.py:12:21 - warning: "Path" 导入项未使用 (reportUnusedImport)
  d:\Python\fcmrawler\src\utils\playwright_detector.py:13:20 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
  d:\Python\fcmrawler\src\utils\playwright_detector.py:13:30 - warning: 此类型自 Python 3.9 起已弃用；请改用 "list" (reportDeprecated)
  d:\Python\fcmrawler\src\utils\playwright_detector.py:13:30 - warning: "List" 导入项未使用 (reportUnusedImport)
  d:\Python\fcmrawler\src\utils\playwright_detector.py:22:14 - warning: 由于这个类未使用 `@final` 装饰，其 `_detected_paths` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\utils\playwright_detector.py:23:14 - warning: 由于这个类未使用 `@final` 装饰，其 `_common_patterns` 属性需要类型注解 (reportUnannotatedClassAttribute)
  d:\Python\fcmrawler\src\utils\playwright_detector.py:39:43 - warning: 此类型自 Python 3.10 起已弃用；请改用 "| None" (reportDeprecated)
...
7 errors, 3701 warnings, 0 notes
```
